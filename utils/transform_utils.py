...
def get_scale_pointclouds(pose, pc):
    pc_homopoints = camera.convert_points_to_homopoints(pc.T)
    scale_pc_homopoints = pose.scale_matrix @ pc_homopoints
    scale_pc_homopoints = camera.convert_homopoints_to_points(scale_pc_homopoints).T
    return scale_pc_homopoints
